    ...
    kWidget.getSources = function (settings) {
        ...
        sourceApi.doRequest(
            ...
            function (result) {
                ...
                var deviceSources = [];
                var protocol = location.protocol.substr(
                    0,
                ...
                for (var i in result[0]["flavorAssets"]) {
                    ...
                    if (asset.tags.toLowerCase().indexOf("web") != -1) {
                        source["data-flavorid"] =
                            asset.videoCodecId + " " + asset.height + "P";
                    ...
                    if (
                        ...
                        (asset.containerFormat &&
                            asset.containerFormat.toLowerCase() == "matroska") || // some ingestion systems give "webm"
                        (asset.containerFormat &&
                ...
                if (ipadAdaptiveFlavors.length != 0) {
                    deviceSources.push({
                        ...
                        src:
                            ...
                            asset.entryId +
                            "/flavorIds/" +
                            ipadAdaptiveFlavors.join(",") +
                            "/format/applehttp/protocol/" +
                            protocol +
                            "/a.m3u8",
                    });
                }
